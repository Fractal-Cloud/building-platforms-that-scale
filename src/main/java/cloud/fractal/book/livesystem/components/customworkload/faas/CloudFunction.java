package cloud.fractal.book.livesystem.components.customworkload.faas;
...
public class CloudFunction extends CustomFunctionWorkload implements LiveSystemComponent {
    public final static Offer.Type TYPE = new Offer.Type(InfrastructureDomain.CUSTOM_WORKLOAD, ServiceDeliveryModel.FAAS, new PascalCaseString("CloudFunction"));
