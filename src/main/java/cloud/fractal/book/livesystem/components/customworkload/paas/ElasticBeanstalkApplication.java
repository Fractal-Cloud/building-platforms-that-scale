...
public class ElasticBeanstalkApplication extends CustomPaaSWorkload implements LiveSystemComponent {
    public final static Offer.Type TYPE = new Offer.Type(InfrastructureDomain.CUSTOM_WORKLOAD, ServiceDeliveryModel.PAAS, new PascalCaseString("ElasticBeanstalkApplication"));
